...
The orchestrator skill SHALL provide comprehensive documentation for the multi-agent workflow, including required sequence, state tracking, and handoff guidance.

#### Scenario: Workflow sequence documentation
- **WHEN** developer invokes orchestrator skill
- **THEN** skill provides documentation of the workflow sequence: planning → implementation → testing → verification
...
- **AND** skill explains the CLI syntax and options
