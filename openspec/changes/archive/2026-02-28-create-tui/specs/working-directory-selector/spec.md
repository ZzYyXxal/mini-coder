...
The system SHALL remember the last used working directory and offer it as the default option in subsequent TUI sessions. Persistence SHALL be stored in user-specific configuration file.
