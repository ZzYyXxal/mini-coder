...
The system shall enforce high-quality Python code standards through the Implementer skill, ensuring all code follows TDD practices, type hints, documentation standards, and PEP 8 compliance.
...
- **THEN** skill provides only function or block being edited
